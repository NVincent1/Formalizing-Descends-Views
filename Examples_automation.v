...
Theorem test_auto_reverse : forall s T n, preserve_Injectivity reverse (s := s) (A := (n::T)).
Proof.
  intros s T n.
...
Theorem test_auto_take_left : forall s T n b, preserve_Injectivity (take_left b) (s := s) (A := ((b+n)::T)).
Proof.
  intros s T n b.
...
Theorem test_auto_take_right : forall s T n a, preserve_Injectivity (take_right a) (s := s) (A := ((a+n)::T)).
Proof.
  intros s T n a.
...
Theorem test_auto_transpose : forall s T n m, preserve_Injectivity transpose (s := s) (A := (m::n::T)).
Proof.
  intros s T n m.
...
Theorem test_auto_group : forall s T n m, preserve_Injectivity (group m) (s := s) (A := (m*n::T)).
Proof.
  intros s T n m.
